...
class ClientKB:
    ...
    async def main_menu() -> InlineKeyboardMarkup:
        ...
        builder.button(text="📋 Прайс-лист", url="https://t.me/asic_mining_store")
        builder.button(text="📞 Связаться с менеджером", url="https://t.me/snooby37")
    ...
    async def profile_menu() -> InlineKeyboardMarkup:
        ...
        builder.button(text="📢 Перейти в канал", url="https://t.me/asic_mining_store")
        builder.button(text="📞 Связаться с менеджером", url="https://t.me/snooby37")
        builder.button(text="🔙 Назад", callback_data="back_main")
        builder.adjust(1)
        return builder.as_markup()
